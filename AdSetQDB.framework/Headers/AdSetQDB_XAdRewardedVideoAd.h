...
@protocol AdSetQDB_XAdRewardedVideoDelegate;

@interface AdSetQDB_XAdRewardedVideoAd : NSObject

/// 代理
@property (nonatomic,weak) id<AdSetQDB_XAdRewardedVideoDelegate>delegate;
