...
@protocol AdSetQDB_XAdNativeExpressDelegete;

@interface AdSetQDB_XAdNativeExpressAd : UIView

/// 代理
@property (weak, nonatomic) id<AdSetQDB_XAdNativeExpressDelegete>delegate;
