...
@protocol AdSetQDB_XAdNativeDelegete;

@interface AdSetQDB_XAdNativeAd : NSObject

/// 代理
@property (weak, nonatomic) id<AdSetQDB_XAdNativeDelegete>delegate;
