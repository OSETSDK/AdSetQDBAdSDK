...
@protocol AdSetQDB_XAdInterstitialDelegate;

@interface AdSetQDB_XAdInterstitialAd : NSObject

/// 代理
@property (weak, nonatomic) id<AdSetQDB_XAdInterstitialDelegate>delegate;
