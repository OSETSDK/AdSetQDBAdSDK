...
@protocol AdSetQDB_XAdSplashDelegate;

@interface AdSetQDB_XAdSplashAd : NSObject

/// 开屏协议
@property (nonatomic,weak) id<AdSetQDB_XAdSplashDelegate>delegate;
