...
@protocol AdSetQDB_XAdWMNativeAdDelegate;

@interface AdSetQDB_XAdWMNativeAd : NSObject

/// 广告类型 Ad type. [必传]
@property (nonatomic,assign) AdSlotType adSlotType;

/// 代理
@property (weak, nonatomic) id<AdSetQDB_XAdWMNativeAdDelegate>delegate;
