...
#import <AdSetQDB/AdSetQDB_XAdLocation.h>
NS_ASSUME_NONNULL_BEGIN

@interface AdSetQDB_XAdWangMaiSDk : NSObject
...
/// @warning  初始化SDK前调用，否则有可能不生效
- (void)setUserLocation:(AdSetQDB_XAdLocation *)location;
